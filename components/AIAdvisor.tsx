...
const AIAdvisor: React.FC<AIAdvisorProps> = ({ expenses }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-600 to-violet-600 rounded-2xl shadow-lg p-6 text-white mb-8 relative overflow-hidden">
          ...
          <div className="mt-6 bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10 min-h-[100px]">
            {loading ? (
              ...
              <div className="prose prose-invert prose-sm max-w-none">
                 {/* Need to render markdown safely. Since we don't have a complex markdown lib installed in the prompt, we will do a basic display or use a simple renderer if available, but standard React is safe for text. Ideally we use react-markdown but sticking to raw text if simple. 
                 Actually, let's just display it with whitespace preserved. */}
