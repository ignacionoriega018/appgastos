...
const NotesModule: React.FC<NotesModuleProps> = ({ notes, onAdd, onDelete }) => {
    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <button 
          ...
          className="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-6 rounded-xl font-semibold transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-200 active:scale-95"
        >
          ...
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl flex flex-col animate-slide-up overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="pt-4">
                <button 
                  type="submit"
                  className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-xl font-bold shadow-lg shadow-indigo-200 transition-transform active:scale-[0.98]"
                >
                  Guardar Nota
                </button>
              </div>
